<template>
  ...
  <v-container class="pr-0 pb-0" fluid>
    <v-row>
      <v-col cols="12">
        <v-card class="" style="text-align: left" elevation="0">
          <v-card-title class="pb-0">new-ella-demo</v-card-title>
          <v-breadcrumbs
            class="breadcrumbs-0"
            density="compact"
            :items="items"
          ...
          >
            <template v-slot:divider>
              <v-icon color="#707070FF" icon="mdi-chevron-right"></v-icon>
            </template>
          </v-breadcrumbs> </v-card
      ></v-col>
      <v-col class="col-check-1" cols="12" sm="12" md="7">
        <v-card elevation="0">
      ...
      >
        ...
        >
          ...
          >
            <v-card-text
              class="p d-flex justify-space-between align-center"
              style="text-align: left"
            >
              <div class="d-flex justify-space-between align-start">
                <div style="width: 100px" class="img img-check">
                  <v-badge
                    :content="data.total"
                    color="#808080FF"
                    offset-x=""
                ...
                <p class="ml-0" style="font-size: 14px; max-width: 400px">
...
export default {
  ...
  methods: {
    ...
    continue_f() {
      this.overlay = false;
      this.favoriteproduct_Delet_All();
      this.$router.push("/");
    },
  },
