  ...
  <v-container fluid class="pa-0">
    <v-row>
      <v-col cols="12" class="pa-0">
        <div class="head-img">
          ...
          <div class="head">
            <div class="head-text mx-auto">
              <h1>
                <span style="color: #10ffdaff">Huge saving</span> on <br />
                UHD Televisions
              </h1>
              <p class="pt-5">sale up 70% off on selected items*</p>
              <v-btn
                class="px-7 my-10"
                variant="outlined"
                style="
    ...
    <v-row>
      <swiper
        ...
        class="swiper-free"
        :modules="modules"
        :slides-per-view="windowsize > 550 ? 2 : 1"
